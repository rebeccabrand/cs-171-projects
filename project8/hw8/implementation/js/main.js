...
function initMainPage(dataArray) {
    ...
    // init table
    myDataTable = new DataTable('tableDiv', dataArray[2], dataArray[3]);

    // TODO - init map
    myMapVis = new MapVis('mapDiv', dataArray[0], dataArray[1], dataArray[2], dataArray[3]);
    // TODO - init bars
    // myBarVisOne = new BarVis('...
    myBarVisOne = new BarVis('barDivOne', dataArray[0], dataArray[1], dataArray[2], dataArray[3], true);
    // myBarVisTwo = new BarVis('...
    myBarVisTwo = new BarVis('barDivTwo', dataArray[0], dataArray[1], dataArray[2], dataArray[3], false);

    // init brush
    myBrushVis = new BrushVis('brushDiv', dataArray[2]);
}

// Align selector button with mapVis data
